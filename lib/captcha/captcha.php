...
$captcha->wordsFile = 'words/fr.php';
...
class SimpleCaptcha {
    ...
    public $backgroundColor = array(62, 48, 40);

    /** Foreground colors in RGB-array */
    public $colors = array(
        array(255,180,48), // orange
        array(239,225,207), // green
        array(243,233,219),  // red
    );
     ...
     */
    public $fonts = array(
        'Antykwa'  => array('spacing' => -3, 'minSize' => 27, 'maxSize' => 30, 'font' => 'brandon_blk-webfont.ttf'),
        'Candice'  => array('spacing' =>-1.5,'minSize' => 28, 'maxSize' => 31, 'font' => 'brandon_bld-webfont.ttf'),
        'DingDong' => array('spacing' => -2, 'minSize' => 24, 'maxSize' => 30, 'font' => 'brandon_reg-webfont.ttf'),
    );
